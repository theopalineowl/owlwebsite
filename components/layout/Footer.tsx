...
import { MailerLiteFooterForm } from "@/components/mailerlite/MailerLiteFooterForm";
...
export function Footer({ settings }: { settings?: SiteSettings | null }) {
  ...
  return (
    <footer className="flex flex-col">
      ...
      <div className="border-t border-[var(--text-muted)]/10 bg-[var(--bg-parchment)] py-12 px-6 md:px-12">
